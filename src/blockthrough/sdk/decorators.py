...
- blockthrough_trace: groups multiple calls under a shared trace
...
from blockthrough.sdk.types import TraceContext
...
# within a `with blockthrough_trace(...)` block share the same trace_id.
...
@contextmanager
def blockthrough_trace(session_id: str, *, trace_id: str | None = None):
    ...
    agent workflow in the Blockthrough dashboard.

    Usage:
        with blockthrough_trace("user-session-42") as trace:
...
def track_openai(
    ...
    *,
    ...
    Usage:
        ...
        track_openai(client, blockthrough_client=ap_client)
    ...
    def patched_create(*args: Any, **kwargs: Any) -> Any:
        ...
        try:
            _report_openai_result(result, elapsed_ms, kwargs, blockthrough_client)
        except Exception:
...
def track_anthropic(
    ...
    *,
    ...
    Usage:
        ...
        track_anthropic(client, blockthrough_client=ap_client)
    ...
    def patched_create(*args: Any, **kwargs: Any) -> Any:
        ...
        try:
            _report_anthropic_result(result, elapsed_ms, kwargs, blockthrough_client)
        except Exception:
...
agentproof_trace = blockthrough_trace
