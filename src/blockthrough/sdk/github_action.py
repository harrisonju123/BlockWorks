...
from blockthrough.sdk.types import CostEstimate, CostEstimateDetail
...
_LLM_CALL_PATTERNS: list[tuple[re.Pattern[str], str, str | None]] = [
    ...
    (re.compile(r"blockthrough.*\.track\(", re.IGNORECASE), "blockthrough_sdk", None),
...
def _build_summary(
    ...
    lines.append(
        ...
        "traffic patterns, and caching. Powered by Blockthrough.*"
    )
