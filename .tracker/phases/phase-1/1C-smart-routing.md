...
- [x] **1C-2** Extend LiteLLM router with BlockThrough policy engine hook — `be2` (done 2026-03-03)
...
- `src/blockthrough/routing/` package: types, policy DSL, router, dry-run, A/B testing
